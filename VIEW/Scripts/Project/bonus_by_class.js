$(document).ready(function () {
    var bonusStudent = new BonusStudentByClass();
})

class BonusStudentByClass extends BaseBonusStudentByClass {
        ...
        if (listID.length === 1) {
            ...
            $.ajax({
                ...
                success: function (res) {
                    ma = res.Code;
                    ten = res.Name;
                    var html = "Bạn có chắc chắn muốn xóa Tuyên dương đã chọn không?";
            ...
            var html = "Bạn có chắc chắn muốn xóa những Tuyên dương đã chọn không?";
            $('#thong-bao').empty();
            $('#thong-bao').append(html);
        }
    ...
    SaveBonusStudentEdit() {
        ...
        object["BonusStudentID"] = listID[0];
