$(document).ready(function () {
    var score = new ScoreByClass();
})

class ScoreByClass extends BaseScoreByClass {
    ...
    InitEvent() {
        ...
        $(document).on('click', '#save', this.SaveScore.bind(this));
        ...
        $(document).on('click', '#save-edit', this.SaveScoreEdit.bind(this));
