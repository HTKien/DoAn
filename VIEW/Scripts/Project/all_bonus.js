$(document).ready(function () {
    var bonusStudent = new BonusStudent();
    $("#search_fulltable_all_bonus").on("keyup", function () {
        var value = $(this).val().toLowerCase();
        $("#table_all_bonus tbody tr").filter(function () {
            $(this).toggle($(this).text().toLowerCase().indexOf(value) > -1)
        });
    });
})

class BonusStudent extends BaseBonusStudent {
